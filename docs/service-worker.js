const CACHE_NAME = "fe-stage-practice-v191";
const APP_SHELL = [
  "./",
  "./index.html",
  "./styles.css?v191",
  "./improvement-questions.js?v191",
  "./subject-b-case-questions.js?v191",
  "./subject-b-case-questions-2.js?v191",
  "./question-choice-sets.js?v191",
  "./sample-derived-questions.js?v191",
  "./app.js?v191",
  "./qa-checklist.html",
  "./qa-checklist.css?v191",
  "./qa-checklist.js?v191",
  ...
  "./assets/enemies/enemy-data-slime.png",
  "./assets/enemies/enemy-exam-guardian.png",
  "./assets/enemies/enemy-knowledge-mimic.png",
  "./assets/enemies/enemy-machine.png",
  "./assets/enemies/enemy-puzzle-golem.png",
  "./assets/enemies/enemy-strategy-mage.png",
  "./assets/enemies/enemy-task-king.png",
  "./assets/enemies/enemy-weakness-shadow.png",
